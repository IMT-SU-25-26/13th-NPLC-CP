import { Prisma, User, Problem, Discussion, Reply, Contest } from "@prisma/client";

export type { User, Problem, Discussion, Reply, Contest };

// Discussion
export const DiscussionInclude =
  Prisma.validator<Prisma.DiscussionInclude>()({
    author: true,
    replies: {
      include: {
        author: true,
...
export const ReplyInclude =
  Prisma.validator<Prisma.ReplyInclude>()({
    author: true,
  });
...
export const ProblemInclude =
  Prisma.validator<Prisma.ProblemInclude>()({
    testCases: true,
  });
